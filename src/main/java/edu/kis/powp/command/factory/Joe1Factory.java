...
public class Joe1Factory {
    ...
    public void setRectangle(){
        commandRectangle.addToList(new ComplexCommandStore(new SetPositionCommand(-120, -120, driver)));
        commandRectangle.addToList(new ComplexCommandStore(new OperateToCommand(120, -120, driver)));
        commandRectangle.addToList(new ComplexCommandStore(new OperateToCommand(120, 120, driver)));
        commandRectangle.addToList(new ComplexCommandStore(new OperateToCommand(-120, 120, driver)));
        commandRectangle.addToList(new ComplexCommandStore(new OperateToCommand(-120, -120, driver)));
        commandRectangle.addToList(new ComplexCommandStore(new OperateToCommand(120, 120, driver)));
